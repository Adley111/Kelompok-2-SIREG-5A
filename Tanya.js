...
const Tanya = ({ navigation }) => {
    const [inputValue, setInputValue] = useState(''); 

    const handleSend = () => {
      if (!inputValue.trim()) { 
        Alert.alert("Peringatan", "Silakan ketikkan pertanyaan sebelum mengirim!"); 
      } else {
        navigation.navigate('Tanyasend'); 
      }
    };
    ...
    <View style={styles.mainContainer}>
      ...
      >
        <View style={styles.bannerContent}>
          ...
          <Text style={styles.bannerText}>Tambahkan {'\n'}Pertanyaanmu</Text>
        </View>
        ...
        <View style={styles.formContainer}>
          ...
          >
            <Text style={styles.formTitle}>Pertanyaan Baru</Text>
          </LinearGradient>
          <TextInput 
            style={styles.input}
